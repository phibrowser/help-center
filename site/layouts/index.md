...
Split View places two pages side by side in the same window, which is useful for reading and writing at once, comparing two pages, or keeping documentation next to a web app instead of jumping back and forth.
