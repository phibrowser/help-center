...
3. Choose the snapshot you want. Phi asks to confirm with **"Restore Time Machine Backup?"**, noting that _Phi will quit and restore it, and the current app and selected user data will be replaced._
