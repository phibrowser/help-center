...
Sometimes you do not want to sit and watch. The agent can run a task **detached in the background**, called a **Shadow Task**, so it keeps working without tying up your conversation or your attention.
...
- reports its progress, results, and any files it produces on Phi Sentinel's **Scheduled Tasks** page, so results do not come back into the chat on their own,
